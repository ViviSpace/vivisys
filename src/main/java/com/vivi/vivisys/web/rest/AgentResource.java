...
public class AgentResource {
    ...
    @GetMapping("/agents")
    @Timed
    public ResponseEntity<List<AgentDTO>> getAllAgents(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<AgentDTO>> searchAgents(@RequestParam String query, @ApiParam Pageable pageable) {
